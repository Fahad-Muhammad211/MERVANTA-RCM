  ...
  return (
    <footer className="border-t border-white/10 bg-ink-950 text-slate-300">
      <Container className="py-16 md:py-20">
        <div className="grid grid-cols-2 gap-x-6 gap-y-12 md:grid-cols-4 lg:[grid-template-columns:repeat(7,minmax(0,1fr))_minmax(0,2fr)]">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm text-slate-400">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+12145550147" className="min-w-0 break-words hover:text-white">+1 (214) 555-0147</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-3.5 w-3.5 shrink-0" />
                <a href="mailto:hello@mervantarcm.com" className="min-w-0 break-words hover:text-white">hello@<wbr />mervantarcm.com</a>
              </li>
